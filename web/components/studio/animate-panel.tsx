...
// Optionnel : image de FIN pour guider la dernière frame (start/end frame).
...
export function AnimatePanel({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium">End frame <span className="font-normal text-muted-foreground">(optional)</span></span>
          {hasHistoryImages && (
